...
$asignaturas = $conexion
    ->query("SELECT a.id, a.nombre, ar.nombre AS area, a.nivel, a.intensidad_horaria,
                    (SELECT GROUP_CONCAT(ag.grado ORDER BY FIELD(ag.grado,
                        'maternal','prejardin','jardin','transicion',
                        'primero','segundo','tercero','cuarto','quinto',
                        'sexto','septimo','octavo','noveno','decimo','once') SEPARATOR ', ') FROM asignatura_grado ag WHERE ag.asignatura_id = a.id) AS grados
             FROM asignaturas a
