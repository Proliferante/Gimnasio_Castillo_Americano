...
$pageTitle = "Boletín de {$estudiante['nombre']}";
        ...
        <?php if ($selected_periodo && isset($boletines_por_periodo[$selected_periodo])): ?>
            <div style="text-align:center;margin-top:16px;">
                <a href="../<?= $boletines_por_periodo[$selected_periodo]['ruta_pdf'] ?>" target="_blank"
                   style="display:inline-flex;align-items:center;gap:8px;color:#fff;background:var(--gold-dark);padding:10px 24px;border-radius:12px;text-decoration:none;font-weight:600;font-size:14px;transition:all.2s;"
                   onmouseover="this.style.background='#b8951f'" onmouseout="this.style.background='var(--gold-dark)'">
